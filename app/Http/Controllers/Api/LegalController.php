 ...
 *
 * The app renders the privacy policy natively so users can read it before
 * they consent — that means no auth, no session. `throttle:30,1` at the route
 * level keeps abuse in check without penalising legitimate readers who might
 * refresh a few times.
 */
