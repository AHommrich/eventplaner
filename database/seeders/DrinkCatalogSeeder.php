...
class DrinkCatalogSeeder extends Seeder
{
    public function run(): void
    {
        $templates = [
            ...
            ['category' => 'longdrink', 'type' => 'vodka_energy',   'base_name' => 'Vodka Energy',   'alcohol_percent' => 10.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Vodka', 'Wodka', 'Energy', 'Longdrink'],            'sort_order_base' => 70],
            ['category' => 'longdrink', 'type' => 'asbach_cola',    'base_name' => 'Asbach Cola',    'alcohol_percent' => 10.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Asbach', 'Weinbrand', 'Cola', 'Longdrink'],         'sort_order_base' => 80],
            ['category' => 'longdrink', 'type' => 'mariacron_cola', 'base_name' => 'Mariacron Cola', 'alcohol_percent' => 10.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Mariacron', 'Weinbrand', 'Cola', 'Longdrink'],      'sort_order_base' => 90],
            ['category' => 'longdrink', 'type' => 'korn_fanta',     'base_name' => 'Korn Fanta',     'alcohol_percent' =>  8.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Korn', 'Fanta', 'Orange', 'Longdrink'],             'sort_order_base' => 100],
            ['category' => 'longdrink', 'type' => 'fanta_ficken',   'base_name' => 'Fanta F***en',   'alcohol_percent' => 10.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Fanta', 'Vodka', 'Longdrink'],                      'sort_order_base' => 110],
            ['category' => 'longdrink', 'type' => 'malibu_maracuja','base_name' => 'Malibu Maracuja','alcohol_percent' =>  8.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Malibu', 'Maracuja', 'Kokos', 'Longdrink'],         'sort_order_base' => 120],
            ['category' => 'longdrink', 'type' => 'vodka_orange',   'base_name' => 'Vodka Orange',   'alcohol_percent' => 10.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Vodka', 'Wodka', 'Orange', 'Longdrink'],            'sort_order_base' => 130],
            ['category' => 'longdrink', 'type' => 'rum_orange',     'base_name' => 'Rum Orange',     'alcohol_percent' => 10.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Rum', 'Orange', 'Longdrink'],                       'sort_order_base' => 140],
            ['category' => 'longdrink', 'type' => 'gin_soda',       'base_name' => 'Gin Soda',       'alcohol_percent' =>  8.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Gin', 'Soda', 'Wacholder', 'Longdrink'],            'sort_order_base' => 150],
            ['category' => 'longdrink', 'type' => 'malibu_orange',  'base_name' => 'Malibu Orange',  'alcohol_percent' =>  8.0, 'is_alcoholic' => true, 'sizes' => [0.2, 0.3], 'search_terms' => ['Malibu', 'Orange', 'Kokos', 'Longdrink'],           'sort_order_base' => 160],
